...
adonis --help
----
Continue, if everything works as expected. Otherwise please create an issue on link:https://github.com/adonisjs/adonis-framework/issues/new[github]
...
2. By default link:https://github.com/adonisjs/adonis-fullstack-app[fullstack app] blueprint will be cloned from Github, which can be customized by passing `--slim` or `--api-only` flag.
