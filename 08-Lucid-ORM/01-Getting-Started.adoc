...
==== is
You may need to determine if two models are the "same". This method can be used to verify that two models have the same primary key, table, and database connection:
