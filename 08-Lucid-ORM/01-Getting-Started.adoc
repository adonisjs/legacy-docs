...
Example use case: you have a model with some hook on creation (eg. set some field to some uuid). To get that value in your model instance object you need to reload model from database.
