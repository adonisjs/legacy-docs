...
NOTE: Make sure to define traits only once. Redefining traits will cause multiple registrations of a trait, and your models will misbehave. The best place of defining *dynamic* traits is inside the Model `boot` method.
