...
2. Each blueprint *callback* receives an instance of link:http://chancejs.com[chancejs] to generate random/fake data.
...
== Password Hashing
link:authentication[Authentication] provider makes use of link:hashing[Hash] provider when verifying the user password. Make sure you are hashing your passwords before saving them to the database.
