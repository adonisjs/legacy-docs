...
== Named Middleware
Named middleware on the other hand are registered with a unique name and you are required to assign them manually on routes. For example The `auth` middleware to protect routes from *unauthenticated* users.
