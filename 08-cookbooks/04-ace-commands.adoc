...
== Creating commands
Let's quickly build a command to pull random quotes of *Paul Graham* using link:http://gophergala.github.io/wisdom[wistom API] and display it on the terminal.
...
== Colorful logs
Ace uses link:https://npmjs.org/package/chalk[chalk] to output colorful messages on the terminal, you can access the instance of chalk as `this.chalk`.
