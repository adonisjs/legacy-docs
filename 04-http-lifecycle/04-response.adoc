...
The reason above code is not going to work, is as soon the route handler is executed, AdonisJs ends the response, and your callback gets executed later, results in an error.
