...
NOTE: Since the code to extend the `Response` needs to be executed once, you can make use of providers or ignitor hooks. Make sure to read link:extending-adonisjs[how to extend] guide before continuing.
