...
Now you can access those variable by using the `get()` method on the `Env` class.
...
WARNING: The `.env` file should never be committed to a source control system like Git or Svn.
