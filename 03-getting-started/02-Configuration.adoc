...
If you are starting your application with the environement variable `NODE_ENV` with `testing`, AdonisJs will load the file `.env.testing` that will override values set in `.env`.
