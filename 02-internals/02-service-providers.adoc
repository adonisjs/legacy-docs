...
1. Since the `Queue/index.js` is in a different directory, we need to tweak the referene of this file inside our service provider.
...
But ofcourse, you want to run all the test files together and for that you can make use of `japa-cli`.
