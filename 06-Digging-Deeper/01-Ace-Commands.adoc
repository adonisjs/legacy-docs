...
== Colorful logs
Ace uses link:https://npmjs.org/package/kleur[kleur, window="_blank"] to colorful output messages on the terminal, you can access the instance of kleur as `this.chalk`.
