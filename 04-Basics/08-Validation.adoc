...
NOTE: You can optionally pass link:https://indicative.adonisjs.com/guides/master/custom-messages[custom error messages, window="_blank"] to return when your validation fails as your third method parameter.
...
==== sanitizor
Returns a reference to Indicative's link:https://indicative.adonisjs.com/guides/master/sanitizer[sanitizor, window="_blank"]:
...
==== formatters
Returns a reference to Indicative's link:https://indicative.adonisjs.com/guides/master/error-formatters[formatters, window="_blank"]:
...
=== Formatter
You can also define the link:https://indicative.adonisjs.com/guides/master/error-formatters#existing-formatters[Indicative formatter, window="_blank"] as a property on the validator class:
