...
NOTE: Since the code to extend `Request` need only execute once, you could use [providers](https://github.com/adonisjs/docs/blob/4.1/02-Concept/03-service-providers.adoc) or [Ignitor hooks](https://github.com/adonisjs/docs/blob/4.1/02-Concept/05-ignitor.adoc) to do so. Read [Extending the Core](https://github.com/adonisjs/docs/blob/4.1/06-Digging-Deeper/03-Extending-the-Core.adoc) for more information.
