...
Next, register the global middleware
...
For all other options, go through the comments inside the link:https://github.com/adonisjs/adonis-cors/blob/develop/example/cors.js#L3[config file, window="_blank"].
